...
cp workingFiles/jpn-d1/radio/new-RADIO.DAT build/jpn-d1/MGS/RADIO.DAT
rm build/jpn-d1/MGS/STAGE.DIR
cp workingFiles/jpn-d1/stage/new-STAGE.DIR build/jpn-d1/MGS/STAGE.DIR
rm build/jpn-d1/MGS/DEMO.DAT
cp workingFiles/jpn-d1/demo/new-DEMO.DAT build/jpn-d1/MGS/DEMO.DAT
rm build/jpn-d1/MGS/VOX.DAT
cp workingFiles/jpn-d1/vox/new-VOX.DAT build/jpn-d1/MGS/VOX.DAT
# 
